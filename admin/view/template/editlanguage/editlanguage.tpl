	...
	<div class="container-fluid">
		...
		<div class="panel panel-default">
			<div class="panel-heading">
				<h3 class="panel-title"><i class="fa fa-pencil"></i><?php echo $text_edit; ?><br/></h3>
			</div>
			<div class="panel-body">
				<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-module" class="form-horizontal">
					<div class="form-group">
						<label class="col-sm-2 control-label status-label" for="input-status"><?php echo $entry_status; ?></label>
					...
					<div class="row"  id="lang-content">
						...
						<div class="row">
							<div class="col-lg-3 col-md-3 col-sm-12">
								<div class="list-group">
									<div class="list-group-item" style="display: flex; justify-content: space-around;">
										<h4 class="list-group-item-heading"><?php echo $text_language_file; ?></h4>
							...
							<div class="col-lg-9 col-md-9 col-sm-12 main_content">
								<div class="alert alert-info"><i class="fa fa-info-circle" class="btn_yellow"></i> <?php echo $text_twig; ?></div>
								<div id="recent"></div>
								<div id="code">
...
<script type="text/javascript">
	...
	$('.tab-content').on('click', '.btn-primary', function(e) {
		...
		$.ajax({
			url: 'index.php?route=<?php echo $route; ?>/save&<?php echo $token_str; ?>&module_lang=' + $('.tab-content .active input[name="module_lang"]').val() + '&path=' + $('.tab-content .active input[name="path"]').val(),
			type: 'post',
	...
	$('.tab-content').on('click', '.reset-file', function(e) {
		...
		if (confirm('<?php echo $text_confirm; ?>')) {
			...
			$.ajax({
				url: 'index.php?route=<?php echo $route; ?>/reset&<?php echo $token_str; ?>&module_lang=' + $('.tab-content .active input[name="module_lang"]').val() + '&path=' + $('.tab-content .active input[name="path"]').val(),
				dataType: 'json',
				beforeSend: function() {
					$(node).button('loading');
				},
