<ul id="menu">
  ...
  <li id="catalog"><a class="parent"><i class="fa fa-tags fa-fw"></i> <span><?php echo $text_catalog; ?></span></a>
    <ul>
      ...
      <li><a href="<?php echo $quick_product_edit; ?>"><?php echo $text_quick_product_edit; ?></a></li>
  ...
  <li id="reseller"><a class="parent"><i class="fa fa-user fa-fw"></i> <span><?php echo $text_reseller; ?></span></a>
    <ul>
      <li><a href="<?php echo $reseller_setting_link; ?>"><?php echo $text_setting; ?></a></li>
      <li><a href="<?php echo $reseller_link; ?>"><?php echo $text_reseller; ?></a></li>
    </ul>
  </li>
