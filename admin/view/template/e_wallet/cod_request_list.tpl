  ...
  <div class="container-fluid">
    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <div class="row">
          <div class="col-md-12">
            <form action="<?php echo $formurl; ?>" method="post">
              ...
              <div class="col-md-2 col-xs-6 email_phone">
                <label > &nbsp; <?php echo $entry_email_phone; ?></label>
                <input type="text" class="form-control" value="<?php echo $email; ?>" name="email">
              </div> &nbsp; 
              <div class="col-md-2 col-xs-6 status">
        ...
        <form action="<?php echo $delete; ?>" method="post" enctype="multipart/form-data" id="form-request">
...
<input  type="hidden" class="dis_edit_url" value="<?php echo $dis_edit; ?>">
