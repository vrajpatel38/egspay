...
class ControllerCatalogProduct extends Controller {
	...
	protected function getForm() {
		...
		$data['tab_faqsss'] = $this->language->get('tab_faqsss');
		...
		if (isset($this->request->post['product_faq'])) {
			$product_faqs = $this->request->post['product_faq'];
		} elseif (isset($this->request->get['product_id'])) {
			$product_faqs = $this->model_catalog_product->getProductFaq($this->request->get['product_id']);
		} else {
			$product_faqs = array();
		}
		
		$data['product_faqs'] = array();
		foreach ($product_faqs as $product_faqs) {
			$data['product_faqs'][] = array(
				'question_id'   => $product_faqs['question_id'],
				'language_id'   => $product_faqs['language_id'],
				'answer_id'     => $product_faqs['answer_id']
			);
		}
