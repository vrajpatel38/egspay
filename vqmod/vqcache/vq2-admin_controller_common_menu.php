...
class ControllerCommonMenu extends Controller {
	public function index() {
		...
		$data['text_reseller'] = $this->language->get('text_reseller');
		...
		if($this->config->get('quick_product_status')){
			$data['text_quick_product_edit'] = $this->language->get('text_quick_product_edit');
			$data['quick_product_edit'] = $this->url->link('catalog/quick_edit', 'token=' . $this->session->data['token'], true);
		}
