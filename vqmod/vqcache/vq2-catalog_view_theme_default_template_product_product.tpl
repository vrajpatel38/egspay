      ...
      <div class="row">
        ...
        <div class="<?php echo $class; ?>">
          ...
          <ul class="list-unstyled">
            ...
            <?php } else { ?>
            <li><span style="text-decoration: line-through;"><span class="price-old"><?php echo $price; ?></span></span></li>
            <li>
  ...
  function PriceOptionChange(){
    $.ajax({
      ...
      dataType: 'json',
        success: function(json) {
        if (json.success) {
          $('#product .price-old').html(json.new_price.price);
          $('#product .price-new').html(json.new_price.special);
          $('#product .price-tax').html("<?php echo $text_tax; ?> " + json.new_price.tax);       
        }
      }
    });
  }     
