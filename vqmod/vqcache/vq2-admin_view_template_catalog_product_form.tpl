      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-product" class="form-horizontal">
          <ul class="nav nav-tabs">
            ...
            <li><a href="#tab-faq" data-toggle="tab"><?php echo $tab_faqsss;?></a></li>
          </ul>
              ...
              <div class="table-responsive">
                <table id="faq" class="table table-striped table-bordered table-hover">
                  ...
                  <tbody>
                    ...
                    <tr id="attribute-row<?php echo $faq_row; ?>">
                      <td class="text-left" style="width: 40%;"><input type="text"
                          name="product_faq[<?php echo $faq_row; ?>][question_]"
                          value="<?php echo $product_faq['question_id']; ?>" placeholder="question"
                          class="form-control" />
                        <input type="hidden" name="product_faq[<?php echo $faq_row; ?>][question_id]"
                          value="<?php echo $product_faq['question_id']; ?>" />
                      </td>
                      <td class="text-left">
                        <?php foreach ($languages as $language) { ?>
                        <div class="input-group"><span class="input-group-addon"><img
                          ...
                          <textarea
                            name="product_faq[<?php echo $faq_row; ?>][product_answer][<?php echo $language['language_id']; ?>][answer_id]"
                            rows="5" placeholder="<?php echo $entry_text; ?>"
                            class="form-control"><?php echo $product_faq['answer_id']; ?></textarea>
                        </div>
                        <?php } ?>
                      </td>
                      <td class="text-left"><button type="button"
                          onclick="$('#attribute-row<?php echo $faq_row; ?>').remove();" data-toggle="tooltip"
                          title="<?php echo $button_remove; ?>" class="btn btn-danger"><i class="fa fa-minus-circle"></i></button>
                      </td>
                    </tr>
                    <?php $faq_row++; ?>
                    <?php } ?>
                  ...
                  <tfoot>
                    <tr>
                      <td colspan="2"></td>
                      <td class="text-left"><button type="button" onclick="addfaq();" data-toggle="tooltip"
...
function addfaq() {
    html  = '<tr id="attribute-row' + faq_row + '">';
	html += '  <td class="text-left" style="width: 20%;"><input type="text" name="product_faq[' + faq_row + '][question_]" value="" placeholder="<?php echo $entry_attribute; ?>" class="form-control" /><input type="hidden" name="product_faq[' + faq_row + '][attribute_id]" value="<?php echo $faq_row; ?>" /></td>';
	html += '  <td class="text-left">';
	<?php foreach ($languages as $language) { ?>
	html += '<div class="input-group"><span class="input-group-addon"><img src="language/<?php echo $language['code']; ?>/<?php echo $language['code']; ?>.png" title="<?php echo $language['name']; ?>" /></span><textarea name="product_faq[' + faq_row + '][product_answer][<?php echo $language['language_id']; ?>][text]" rows="5" placeholder="<?php echo $entry_text; ?>" class="form-control"></textarea></div>';
    <?php } ?>
	html += '  </td>';
	html += '  <td class="text-left"><button type="button" onclick="$(\'#attribute-row' + faq_row + '\').remove();" data-toggle="tooltip" title="<?php echo $button_remove; ?>" class="btn btn-danger"><i class="fa fa-minus-circle"></i></button></td>';
    html += '</tr>';

	$('#faq tbody').append(html);

	// attributeautocomplete(faq_row);
